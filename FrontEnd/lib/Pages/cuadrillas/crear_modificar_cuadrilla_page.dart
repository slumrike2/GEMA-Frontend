...
//  String? _selectedLeaderUuid;
//  String? _selectedMemberUuid;
...
//
//    try {
//      // Cargar equipos técnicos y técnicos no asignados en paralelo
//      final teamsFuture = TechnicalTeamService.getAll();
//      final unassignedFuture = TechnicianService.getUnassigned();
//
//      final results = await Future.wait([teamsFuture, unassignedFuture]);
//
//      setState(() {
//        technicalTeams = results[0] as List<TechnicalTeam>;
//        _unassigned = (results[1] as List).cast<Map<String, dynamic>>();
//        isLoading = false;
//      });
//    } catch (e) {
//      setState(() {
...
//  }
//
//  void _onAgregarMiembroDesdeDisponibles() {
//    if (_selectedMemberUuid == null) return;
//    final item = _unassigned.firstWhere(
//      (e) => e['uuid'] == _selectedMemberUuid,
//      orElse: () => {},
//    );
//    if (item.isEmpty) return;
//    final String name = (item['name'] as String?)?.trim().isNotEmpty == true
//        ? item['name'] as String
//        : 'Sin nombre';
//    final String ci = (item['personalId'] as String?) ?? '';
//    // Evitar duplicados por CI
//    final exists = miembros.any((m) => (m['ci'] ?? '') == ci);
//    if (exists) return;
//    setState(() {
//      miembros.add({"nombre": name, "ci": ci});
//      _nombreControllers.add(TextEditingController(text: name));
//      _ciControllers.add(TextEditingController(text: ci));
//      // Remover de disponibles para no repetir
//      _unassigned.removeWhere((e) => e['uuid'] == _selectedMemberUuid);
//      _selectedMemberUuid = null;
//    });
//  }
//
...
//                        // Selector opcional desde técnicos no asignados
//                        DropdownButtonFormField<String>(
//                          value: _selectedLeaderUuid,
//                          items: _unassigned
//                              .map((t) => DropdownMenuItem<String>(
//                                    value: t['uuid'] as String,
//                                    child: Text(
//                                      '${(t['name'] ?? 'Sin nombre')} • CI: ${(t['personalId'] ?? '')}',
//                                      overflow: TextOverflow.ellipsis,
//                                    ),
//                                  ))
//                              .toList(),
//                          onChanged: (v) => setState(() {
//                            _selectedLeaderUuid = v;
//                          }),
//                          decoration: const InputDecoration(
//                            labelText: 'Elegir líder desde disponibles',
//                            border: OutlineInputBorder(),
//                          ),
//                        ),
...
//                            onPressed: _selectedLeaderUuid == null
//                                ? null
//                                : () {
//                                    final item = _unassigned.firstWhere(
//                                      (e) => e['uuid'] == _selectedLeaderUuid,
//                                      orElse: () => {},
//                                    );
//                                    if (item.isEmpty) return;
//                                    final name = (item['name'] as String?) ?? '';
//                                    setState(() {
//                                      _liderController.text = name;
//                                      // Si deseas evitar que el líder también esté en la lista de disponibles
//                                      _unassigned.removeWhere(
//                                          (e) => e['uuid'] == _selectedLeaderUuid);
//                                      _selectedLeaderUuid = null;
//                                    });
//                                  },
//                            icon: const Icon(Icons.person_add_alt_1),
//                            label: const Text('Usar seleccionado como líder'),
//                          ),
//                        ),
//                      ],
//                    ),
...
//                  ),
//                  const SizedBox(height: 8),
//                  // Selector desde técnicos no asignados
//                  Row(
//                    children: [
//                      Expanded(
//                        child: DropdownButtonFormField<String>(
//                          value: _selectedMemberUuid,
//                          items: _unassigned
//                              .map((t) => DropdownMenuItem<String>(
//                                    value: t['uuid'] as String,
//                                    child: Text(
...
//                              .toList(),
//                          onChanged: (v) => setState(() {
//                            _selectedMemberUuid = v;
//                          }),
//                          decoration: const InputDecoration(
//                            labelText: 'Agregar miembro desde disponibles',
//                            border: OutlineInputBorder(),
//                          ),
//                        ),
//                      ),
...
//                      ElevatedButton(
//                        onPressed: _onAgregarMiembroDesdeDisponibles,
